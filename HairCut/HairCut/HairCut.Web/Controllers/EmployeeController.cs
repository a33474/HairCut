...
namespace HairCut.Web.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public ActionResult CreateEmployee(EmployeeVm employeeVm)
        {
        ...
        {
            EmployeeVm employeeVm = _employeeService.GetEmployee(y => y.Id ==id);
            return View(employeeVm );
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult EditEmployee(EmployeeVm employeeVm)
        {
            if (ModelState.IsValid)
            {
                _employeeService.AddOrUpdateEmployee(employeeVm);
